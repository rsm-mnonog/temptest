...
## Data
Sample Size: 50,083 prior donors were included in the study.
Treatment Group: 33,396 (67%)
Control Group: 16,687 (33%)
Overall Giving:
Total raised: $45,860
Control group: $13,566
Treatment group: $32,294
Average revenue per letter:
Control: $0.81
Treatment: $0.97 (excluding match funds)
Effect of Matching Grants:
Response Rate: Increased by 22% in the treatment group
Revenue per solicitation: Increased by 19%
Higher match ratios ($2:$1 and $3:$1) did not outperform the basic $1:$1 match
Conditional Giving (among those who donated):
Average gift size remained largely unchanged across treatments
Political Geography Effects:
In red states (voted for Bush in 2004), match letters raised 55% more per solicitation
In blue states, the match had no statistically significant effect
Elasticity Estimate:
The implied price elasticity of giving due to matching (not tax deductibility) was estimated at –0.30, aligning with or slightly lower than tax-related elasticities found in other literature
