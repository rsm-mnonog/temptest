...
::: {.pf-downloads}
[Download the full report (PDF)](other_docs/Netflix_Company_Analysis_Final.pdf){.pf-download-btn target="_blank"} [Download the Excel valuation model (.xlsx)](other_docs/NFLX_Company_Analysis_Model.xlsx){.pf-download-btn .pf-download-btn-outline}
:::
